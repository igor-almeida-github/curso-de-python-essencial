...
Se um programa Python for executado com o parâmetro -O, nenhum assertion será validado. Ou seja,
...
def comer_fast_food(food):
    assert comida in ['pizza', 'sorvete', 'batata frita', 'cachorro quente'], 'A comida precisa ser fast food'
    return f'Eu estou comendo {food}'
